...
public class WeekViewEvent {
     ...
     */
    public WeekViewEvent(Object id, String name, int startYear, int startMonth, int startDay, int startHour, int startMinute, int endYear, int endMonth, int endDay, int endHour, int endMinute) {
        this.mId = id;
     ...
     */
    public WeekViewEvent(Object id, String name, String location, Calendar startTime, Calendar endTime, boolean allDay) {
        this.mId = id;
        this.mName = name;
     ...
     * @param endTime The time when the event ends.
     */
    public WeekViewEvent(Object id, String name, String location, Calendar startTime, Calendar endTime) {
     ...
     * @param endTime The time when the event ends.
     */
    public WeekViewEvent(Object id, String name, Calendar startTime, Calendar endTime) {
