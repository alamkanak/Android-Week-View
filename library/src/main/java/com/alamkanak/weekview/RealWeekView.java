 ...
 */
final class RealWeekView<T> extends WeekView<T>
    ...
    public RealWeekView(Context context) {
        this(context, null);
    }

    public RealWeekView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RealWeekView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        RealWeekView.width = width;
        RealWeekView.height = height;
    }
    ...
    public void setShowHourSeparators(boolean showHourSeparators) {
        ...
        invalidate(); // TODO: Test (add option to restore current time)
    }
    ...
    public void setDaySeparatorColor(int daySeparatorColor) {
        ...
        // TODO config.drawingConfig.hourSeparatorPaint.setColor(daySeparatorColor);
        invalidate();
    }
